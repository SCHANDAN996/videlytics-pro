# Generated by Django 5.0.7 on 2025-09-14 10:00
...
class Migration(migrations.Migration):
    ...
    # This migration depends on the creation of the User model and the Site model.
    dependencies = [
        ('sites', '0001_initial'), # This ensures the Sites table is created first
